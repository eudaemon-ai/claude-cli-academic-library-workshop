...
Once installed, navigate to the `library-context/` folder and start Claude Code with `claude`. You'll use `library-stats.txt` throughout this module — you'll pass it to Claude directly with the `@` syntax.
